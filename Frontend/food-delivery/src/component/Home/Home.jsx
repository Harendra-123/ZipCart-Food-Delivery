        ...
        <div className='pb-10'>
         <section className=' banner -z-50 relative flex flex-col justify-center items-center'>
            ...
            <div className='w-[50vw] z-10 text-center'>
                ...
                <p className='z-10 text-gray-300 text-xl lg:text-4xl'>Taste the convenience : Food , Fast and Dlevered.</p>
            </div>
         ...
         <section className='px-5 lg:px-20 pt-10 '>
            <h1 className='text-2xl font-semibold text-gray-400 pb-8 '> Order From 
